#############################################################################
# Makefile for building: fitmap_dev.app/Contents/MacOS/fitmap_dev
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  fitmap_dev.pro
# Template: app
# Command: /Users/clintongoldstein/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=x86_64 -o Makefile fitmap_dev.pro
#############################################################################
...
INCPATH       = -I. -I../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I../Qt/5.7/clang_64/lib/QtGui.framework/Headers -I../Qt/5.7/clang_64/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I../Qt/5.7/clang_64/mkspecs/macx-clang -F/Users/clintongoldstein/Qt/5.7/clang_64/lib
QMAKE         = /Users/clintongoldstein/Qt/5.7/clang_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = fitmap_dev1.0.0
DISTDIR = /Users/clintongoldstein/fitmap_dev/.tmp/fitmap_dev1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -mmacosx-version-min=10.8 -Wl,-rpath,/Users/clintongoldstein/Qt/5.7/clang_64/lib
LIBS          = $(SUBLIBS) -F/Users/clintongoldstein/Qt/5.7/clang_64/lib -framework QtWidgets -framework QtGui -framework QtCore -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL 
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		mathfunctions.cpp qrc_fit_map_rescource.cpp \
		moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		mathfunctions.o \
		qrc_fit_map_rescource.o \
		moc_mainwindow.o
DIST          = undo.png \
		...
		fitmap_dev.pro mainwindow.h \
		mathfunctions.h main.cpp \
		mainwindow.cpp \
		mathfunctions.cpp
QMAKE_TARGET  = fitmap_dev
DESTDIR       = 
TARGET        = fitmap_dev.app/Contents/MacOS/fitmap_dev
...
$(TARGET): ui_mainwindow.h $(OBJECTS)  
	@test -d fitmap_dev.app/Contents/MacOS/ || mkdir -p fitmap_dev.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: fitmap_dev.pro ../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=x86_64 -o Makefile fitmap_dev.pro
../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf:
../Qt/5.7/clang_64/mkspecs/qdevice.pri:
../Qt/5.7/clang_64/mkspecs/features/device_config.prf:
../Qt/5.7/clang_64/mkspecs/common/unix.conf:
...
fitmap_dev.app/Contents/PkgInfo: 
	@test -d fitmap_dev.app/Contents || mkdir -p fitmap_dev.app/Contents
	@$(DEL_FILE) fitmap_dev.app/Contents/PkgInfo
	@echo "APPL????" > fitmap_dev.app/Contents/PkgInfo
fitmap_dev.app/Contents/Resources/empty.lproj: 
	@test -d fitmap_dev.app/Contents/Resources || mkdir -p fitmap_dev.app/Contents/Resources
	@touch fitmap_dev.app/Contents/Resources/empty.lproj
	
fitmap_dev.app/Contents/Info.plist: 
	@test -d fitmap_dev.app/Contents || mkdir -p fitmap_dev.app/Contents
	@$(DEL_FILE) fitmap_dev.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,unlv.fitmap-dev,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,fitmap_dev,g" -e "s,@LIBRARY@,fitmap_dev,g" -e "s,@TYPEINFO@,????,g" ../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >fitmap_dev.app/Contents/Info.plist

all: Makefile \
		fitmap_dev.app/Contents/PkgInfo \
		fitmap_dev.app/Contents/Resources/empty.lproj \
		fitmap_dev.app/Contents/Info.plist $(TARGET)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents fit_map_rescource.qrc $(DISTDIR)/
	$(COPY_FILE) --parents mainwindow.h mathfunctions.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp mathfunctions.cpp $(DISTDIR)/
...
compiler_rcc_make_all: qrc_fit_map_rescource.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_fit_map_rescource.cpp
qrc_fit_map_rescource.cpp: fit_map_rescource.qrc \
		...
		unnamed.png \
		unnamed-1.png
	/Users/clintongoldstein/Qt/5.7/clang_64/bin/rcc -name fit_map_rescource fit_map_rescource.qrc -o qrc_fit_map_rescource.cpp
...
moc_mainwindow.cpp: ../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QMainWindow \
	...
	/Users/clintongoldstein/Qt/5.7/clang_64/bin/moc $(DEFINES) -D__APPLE__ -D__GNUC__=4 -D__APPLE_CC__ -I/Users/clintongoldstein/Qt/5.7/clang_64/mkspecs/macx-clang -I/Users/clintongoldstein/fitmap_dev -I/Users/clintongoldstein/Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I/Users/clintongoldstein/Qt/5.7/clang_64/lib/QtGui.framework/Headers -I/Users/clintongoldstein/Qt/5.7/clang_64/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1 -I/usr/local/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/8.0.0/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I/usr/include -I'/System/Library/Frameworks (framework directory)' -I'/Library/Frameworks (framework directory)' -F/Users/clintongoldstein/Qt/5.7/clang_64/lib mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: mainwindow.ui \
	...
	/Users/clintongoldstein/Qt/5.7/clang_64/bin/uic mainwindow.ui -o ui_mainwindow.h
...
qrc_fit_map_rescource.o: qrc_fit_map_rescource.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_fit_map_rescource.o qrc_fit_map_rescource.cpp
